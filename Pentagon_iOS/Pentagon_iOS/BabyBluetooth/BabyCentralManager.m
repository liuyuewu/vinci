...
//    [centralManager scanForPeripheralsWithServices:@[[CBUUID UUIDWithString:@"0000FF11-0000-1000-8000-00805F9B34FB"]] options:nil];
    
//    [centralManager scanForPeripheralsWithServices:@[[CBUUID UUIDWithString:@"0ECDE911-CC17-40E6-9EC3-9E198F3c12A8"],[CBUUID UUIDWithString:@"9FA480E0-4967-4542-9390-D343DC5D04AE"]] options:nil];
    NSLog(@"[currChannel babyOptions].scanForPeripheralsWithServices:----%@",[currChannel babyOptions].scanForPeripheralsWithServices);
    [centralManager scanForPeripheralsWithServices:nil options:[currChannel babyOptions].scanForPeripheralsWithOptions];
}
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI {
    ...
    //日志
    BabyLog(@"当扫描到设备:%@\n%@",peripheral.services,advertisementData);
