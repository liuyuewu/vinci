...
@implementation UIDevice (YNHardware)
...
+ (NSString *)yn_platformString{
    NSString *platform = [self yn_platform];
...
+ (NSUInteger)yn_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)yn_cpuFrequency {
    return [self yn_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)yn_busFrequency {
    return [self yn_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)yn_ramSize {
    return [self yn_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)yn_cpuNumber {
    return [self yn_getSysInfo:HW_NCPU];
}


+ (NSUInteger)yn_totalMemoryBytes
{
    return [self yn_getSysInfo:HW_PHYSMEM];
}
