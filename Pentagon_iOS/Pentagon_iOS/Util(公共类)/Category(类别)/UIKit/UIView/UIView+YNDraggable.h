 ...
 */
@property (nonatomic) UIPanGestureRecognizer *yn_panGesture;
 ...
 */
@property (nonatomic) CGRect yn_cagingArea;
 ...
 */
@property (nonatomic) CGRect yn_handle;

/**
 Restricts the movement along the X axis
 */
@property (nonatomic) BOOL yn_shouldMoveAlongX;

/**
 Restricts the movement along the Y axis
 */
@property (nonatomic) BOOL yn_shouldMoveAlongY;

/**
 Notifies when dragging started
 */
@property (nonatomic, copy) void (^yn_draggingStartedBlock)();

/**
 Notifies when dragging ended
 */
@property (nonatomic, copy) void (^yn_draggingEndedBlock)();
