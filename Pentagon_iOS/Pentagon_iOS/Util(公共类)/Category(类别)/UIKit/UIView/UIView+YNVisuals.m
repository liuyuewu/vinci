...
// Degree -> Rad
#define yn_degToRad(x) (M_PI * (x) / 180.0)

@implementation UIView (YNVisuals)

///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////

-(void)yn_cornerRadius: (CGFloat)radius strokeSize: (CGFloat)size color: (UIColor *)color
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)yn_setRoundedCorners:(UIRectCorner)corners radius:(CGFloat)radius {
...
-(void)yn_addSubview: (UIView *)subview withTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
	[UIView beginAnimations: nil context: NULL];
	[UIView setAnimationDuration: duration];
      ...
      timingFunction: (CAMediaTimingFunction *)timingFunction
{
    ...
    rotation.toValue = [NSNumber numberWithFloat: yn_degToRad(angle)];
