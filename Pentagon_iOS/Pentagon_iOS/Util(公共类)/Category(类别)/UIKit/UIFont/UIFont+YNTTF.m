...
@implementation UIFont (YNTTF)

+ (UIFont *)yn_fontWithTTFAtURL:(NSURL *)URL size:(CGFloat)size{
	...
	return [UIFont yn_fontWithTTFAtPath:URL.path size:size];
}

+ (UIFont *)yn_fontWithTTFAtPath:(NSString *)path size:(CGFloat)size{
