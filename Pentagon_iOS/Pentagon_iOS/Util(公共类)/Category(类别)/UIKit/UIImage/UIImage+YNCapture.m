...
@implementation UIImage (YNCapture)
/**
 *  @brief  截图指定view成图片
 *
 *  @param view 一个view
 ...
 *  @return 图片
 */
+ (UIImage *)yn_captureWithView:(UIView *)view
{
...
+ (UIImage *)yn_getImageWithSize:(CGRect)myImageRect FromImage:(UIImage *)bigImage
{
    //大图bigImage
    //定义myImageRect，截图的区域
 ...
 *  @return 截图
 */
+ (UIImage *)yn_screenshotWithView:(UIView *)aView limitWidth:(CGFloat)maxWidth{
