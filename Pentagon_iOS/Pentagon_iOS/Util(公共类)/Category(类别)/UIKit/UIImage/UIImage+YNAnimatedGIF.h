...
*/
@interface UIImage (YNAnimatedGIF)

/*
        UIImage *animation = [UIImage yn_animatedImageWithAnimatedGIFData:theData];
...
*/
+ (UIImage *)yn_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
        UIImage *image = [UIImageyn_ animatedImageWithAnimatedGIFURL:theURL];
...
*/
+ (UIImage *)yn_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
