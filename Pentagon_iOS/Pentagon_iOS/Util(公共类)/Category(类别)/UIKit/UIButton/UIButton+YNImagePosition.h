...
typedef NS_ENUM(NSInteger, YNImagePosition) {
...
@interface UIButton (YNImagePosition)
 ...
 */
- (void)yn_setImagePosition:(YNImagePosition)postion spacing:(CGFloat)spacing;
