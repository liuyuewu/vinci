...
@implementation UIImageView (YNGeometryConversion)

- (CGPoint)yn_convertPointFromImage:(CGPoint)imagePoint {
...
- (CGRect)yn_convertRectFromImage:(CGRect)imageRect {
    CGPoint imageTopLeft     = imageRect.origin;
    CGPoint imageBottomRight = CGPointMake(CGRectGetMaxX(imageRect),
                                          CGRectGetMaxY(imageRect));
    
    CGPoint viewTopLeft     = [self yn_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self yn_convertPointFromImage:imageBottomRight];
...
- (CGPoint)yn_convertPointFromView:(CGPoint)viewPoint {
...
- (CGRect)yn_convertRectFromView:(CGRect)viewRect {
    CGPoint viewTopLeft = viewRect.origin;
    CGPoint viewBottomRight = CGPointMake(CGRectGetMaxX(viewRect), 
                                          CGRectGetMaxY(viewRect));
    
    CGPoint imageTopLeft = [self yn_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self yn_convertPointFromView:viewBottomRight];
