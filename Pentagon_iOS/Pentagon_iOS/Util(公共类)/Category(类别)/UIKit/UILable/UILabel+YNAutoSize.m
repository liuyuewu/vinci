...
@implementation UILabel (YNAutoSize)
-(UILabel *)yn_resizeLabelHorizontal{
    return [self yn_resizeLabelHorizontal:0];
}

- (UILabel *)yn_resizeLabelVertical{
    return [self yn_resizeLabelVertical:0];
}

- (UILabel *)yn_resizeLabelVertical:(CGFloat)minimumHeigh{
...
- (UILabel *)yn_resizeLabelHorizontal:(CGFloat)minimumWidth{
    CGRect newFrame = self.frame;
