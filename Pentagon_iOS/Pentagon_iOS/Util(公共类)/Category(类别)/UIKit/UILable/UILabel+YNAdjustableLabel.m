...
@implementation UILabel (YNAdjustableLabel)

// General method. If minSize is set to CGSizeZero then
// it is ignored.
// =====================================================
- (void)yn_adjustLabelToMaximumSize:(CGSize)maxSize
                 ...
                 minimumFontSize:(int)minFontSize
{
  ...
  // Now, calculate the size of the label constrained to maxSize
    CGSize tempSize = [[self text] boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName : [self font]} context:nil].size;
...
//                                lineBreakMode:[self lineBreakMode]];
  ...
  do {
    ...
    calculatedSizeWithCurrentFontSize = [[self text] boundingRectWithSize:unconstrainedSize options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName : labelFont} context:nil].size;
...
- (void)yn_adjustLabelToMaximumSize:(CGSize)maxSize
                 minimumFontSize:(int)minFontSize
{
  [self yn_adjustLabelToMaximumSize:maxSize
...
// =====================================================
- (void)yn_adjustLabelSizeWithMinimumFontSize:(int)minFontSize
{
  [self yn_adjustLabelToMaximumSize:CGSizeZero
                     minimumSize:CGSizeZero 
                 minimumFontSize:minFontSize];
}
