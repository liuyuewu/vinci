...
static void YNSVGApplier(void* info, const CGPathElement* element);
...
- (NSString*)yn_SVGString
{
    ...
    CGPathApply(path, (__bridge_retained void*)SVGString, YNSVGApplier);
    NSString *lineCap;
