...
typedef struct YNBezierSubpath {
    CGPoint startPoint;
...
@implementation UIBezierPath (YNLength)
...
- (void)extractSubpaths:(YNBezierSubpath*)subpathArray
{
...
- (CGPoint)pointAtPercent:(CGFloat)t ofSubpath:(YNBezierSubpath)subpath {
...
- (CGFloat)yn_length {
	...
	YNBezierSubpath subpaths[subpathCount];
...
- (CGPoint)yn_pointAtPercentOfLength:(CGFloat)percent {
    ...
    YNBezierSubpath subpathContainingPoint;
	for (NSUInteger i = 0; i < subpathCount; i++) {
