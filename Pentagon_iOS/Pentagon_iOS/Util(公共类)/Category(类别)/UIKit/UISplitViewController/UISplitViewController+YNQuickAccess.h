...
@interface UISplitViewController (YNQuickAccess)

@property (weak, readonly, nonatomic) UIViewController *yn_leftController;
@property (weak, readonly, nonatomic) UIViewController *yn_rightController;
