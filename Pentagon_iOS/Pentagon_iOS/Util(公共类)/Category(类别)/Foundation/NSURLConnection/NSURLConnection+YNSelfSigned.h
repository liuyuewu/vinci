...
@interface NSURLConnection (YNSelfSigned)
/**
 *  @author ynCategories
 *
 ...
 *
 */
+ (void)yn_sendAsynchronousRequestAcceptingAllCerts:(NSURLRequest *)request queue:(NSOperationQueue *)queue completionHandler:(void (^)(NSURLResponse *, NSData *, NSError *))handler;
