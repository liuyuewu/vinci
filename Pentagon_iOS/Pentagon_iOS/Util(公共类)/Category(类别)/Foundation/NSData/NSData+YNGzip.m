...
@implementation NSData (YNGzip)

static void *yn_libzOpen()
{
    static void *libz;
...
{
    if (self.length == 0 || [self yn_isGzippedData])
    {
        return self;
    }
    
    void *libz = yn_libzOpen();
...
{
    return [self yn_gzippedDataWithCompressionLevel:-1.0f];
}
