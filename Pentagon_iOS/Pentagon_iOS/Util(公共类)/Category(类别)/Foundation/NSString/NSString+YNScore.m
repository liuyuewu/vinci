...
@implementation NSString (YNScore)


- (CGFloat)yn_scoreAgainst:(NSString *)otherString{
    return [self yn_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)yn_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self yn_scoreAgainst:otherString fuzziness:fuzziness options:NSStringYNScoreOptionNone];
}

- (CGFloat)yn_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringYNScoreOption)options{
    ...
    if(NSStringYNScoreOptionFavorSmallerWords == (options & NSStringYNScoreOptionFavorSmallerWords)){
    ...
    if(NSStringYNScoreOptionReducedLongStringPenalty == (options & NSStringYNScoreOptionReducedLongStringPenalty)){
