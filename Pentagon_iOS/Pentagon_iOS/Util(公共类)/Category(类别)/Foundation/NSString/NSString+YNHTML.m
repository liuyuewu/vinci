...
static yn_HTMLEscapeMap yn_gAsciiHTMLEscapeMap[] = {
...
static yn_HTMLEscapeMap yn_gUnicodeHTMLEscapeMap[] = {
...
static int yn_EscapeMapCompare(const void *ucharVoid, const void *mapVoid) {
    const unichar *uchar = (const unichar*)ucharVoid;
    const yn_HTMLEscapeMap *map = (const yn_HTMLEscapeMap*)mapVoid;
    int val;
    if (*uchar > map->uchar) {
        val = 1;
...
@implementation NSString (YNHTML)

- (NSString *)yn_stringByEscapingHTMLUsingTable:(yn_HTMLEscapeMap*)table
    ...
    for (NSUInteger i = 0; i < length; ++i) {
        yn_HTMLEscapeMap *val = bsearch(&buffer[i], table,
                                        size / sizeof(yn_HTMLEscapeMap),
                                        sizeof(yn_HTMLEscapeMap), yn_EscapeMapCompare);
...
- (NSString *)yn_stringByEscapingForHTML {
    return [self yn_stringByEscapingHTMLUsingTable:yn_gUnicodeHTMLEscapeMap
                                            ofSize:sizeof(yn_gUnicodeHTMLEscapeMap)
                                   escapingUnicode:NO];
} // gtm_stringByEscapingHTML

- (NSString *)yn_stringByEscapingForAsciiHTML {
    return [self yn_stringByEscapingHTMLUsingTable:yn_gAsciiHTMLEscapeMap
                                            ofSize:sizeof(yn_gAsciiHTMLEscapeMap)
                                   escapingUnicode:YES];
} // gtm_stringByEscapingAsciiHTML

- (NSString *)yn_stringByUnescapingFromHTML {
    ...
    do {
        ...
        if (length > 3 && length < 11) {
            if ([escapeString characterAtIndex:1] == '#') {
                ...
                // "standard" sequences
                for (unsigned i = 0; i < sizeof(yn_gAsciiHTMLEscapeMap) / sizeof(yn_HTMLEscapeMap); ++i) {
                    if ([escapeString isEqualToString:yn_gAsciiHTMLEscapeMap[i].escapeSequence]) {
                        [finalString replaceCharactersInRange:escapeRange withString:[NSString stringWithCharacters:&yn_gAsciiHTMLEscapeMap[i].uchar length:1]];
                        break;
                    }
                }
            }
...
- (NSString *)yn_stringWithNewLinesAsBRs {
    @autoreleasepool {
        // Strange New lines:
        //	Next Line, U+0085
        //	Form Feed, U+000C
...
- (NSString *)yn_stringByRemovingNewLinesAndWhitespace {
    @autoreleasepool {
...
- (NSString *)yn_stringByLinkifyingURLs {
...
- (NSString *)yn_stringByStrippingTags {
    @autoreleasepool {
        ...
        finalString = [result yn_stringByRemovingNewLinesAndWhitespace];
...
- (NSString *)yn_stringByConvertingHTMLToPlainText {
    @autoreleasepool {
        // Character sets
        NSCharacterSet *stopCharacters = [NSCharacterSet characterSetWithCharactersInString:[NSString stringWithFormat:@"< \t\n\r%C%C%C%C", (unichar)0x0085, (unichar)0x000C, (unichar)0x2028, (unichar)0x2029]];
        NSCharacterSet *newLineAndWhitespaceCharacters = [NSCharacterSet characterSetWithCharactersInString:[NSString stringWithFormat:@" \t\n\r%C%C%C%C", (unichar)0x0085, (unichar)0x000C, (unichar)0x2028, (unichar)0x2029]];
        NSCharacterSet *tagNameCharacters = [NSCharacterSet characterSetWithCharactersInString:@"abcdefghiynlmnopqrstuvwxyzABCDEFGHIynLMNOPQRSTUVWXYZ"];
        ...
        NSString *retString = [result yn_stringByUnescapingFromHTML];
