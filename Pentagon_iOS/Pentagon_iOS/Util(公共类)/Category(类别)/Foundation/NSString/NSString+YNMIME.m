...
@implementation NSString (YNMIME)
...
- (NSString *)yn_MIMEType {
    return [[self class] yn_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)yn_MIMETypeForExtension:(NSString *)extension {
    return [[self yn_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
