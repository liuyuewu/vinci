...
@implementation NSString (YNStringPages)
...
- (NSArray *)yn_getPagesOfString:(NSString *)cache
    ...
    for (int p = 0; p<[paragraphs count]; p++) {
        ...
        CGSize paraSize=[para boundingRectWithSize:r.size options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName :font} context:nil].size;
