...
@interface NSRunLoop (YNPerformBlock)
/**
 *  @author ishkawa
 *
 ...
 */
- (void)yn_performBlockAndWait:(void (^)(BOOL *finish))block;
/**
 *  @author ishkawa
 *
 *  @brief   extension of NSRunLoop for waiting.
 ...
 *  @param block <#block description#>
 */
- (void)yn_performBlockAndWait:(void (^)(BOOL *finish))block timeoutInterval:(NSTimeInterval)timeoutInterval;
