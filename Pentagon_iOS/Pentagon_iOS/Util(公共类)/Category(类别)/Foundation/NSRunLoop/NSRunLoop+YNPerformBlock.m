...
@implementation NSRunLoop (YNPerformBlock)

- (void)yn_performBlockAndWait:(void (^)(BOOL *))block
{
    [self yn_performBlockAndWait:block timeoutInterval:10.0];
}

- (void)yn_performBlockAndWait:(void (^)(BOOL *))block timeoutInterval:(NSTimeInterval)timeoutInterval
{
