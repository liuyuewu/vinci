...
#import "CAAnimation+YNEasingEquations.h"
...
@implementation CAAnimation (ynEasingEquations)
...
+ (CAKeyframeAnimation*)yn_transformAnimationWithDuration:(CGFloat)duration
...
+ (void)yn_addAnimationToLayer:(CALayer *)layer
                   duration:(CGFloat)duration
                  transform:(CATransform3D)transform
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self yn_transformAnimationWithDuration:duration
...
+ (CAKeyframeAnimation*)yn_animationWithKeyPath:(NSString*)keyPath
                                    duration:(CGFloat)duration
...
+ (void)yn_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    [self yn_addAnimationToLayer:layer
                  withKeyPath:keyPath
                     duration:duration
...
+ (void)yn_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self yn_animationWithKeyPath:keyPath
                                               duration:duration
                                                   from:startValue
                                                     to:endValue
                                         easingFunction:easingFunction];
